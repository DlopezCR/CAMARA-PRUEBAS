...
class CaptureFragment : Fragment() {
    ...
    private suspend fun bindCaptureUsecase() {
        ...
        val cameraProvider1 = ProcessCameraProvider.getInstance(requireContext()).await()
                ...
                for (camSelector in arrayOf(
                    ...
                    try {
                        ...
                        if (provider.hasCamera(camSelector)) {
                            println("Código de dupuración")
                            val pintS = provider.bindToLifecycle(viewLifecycleOwner,camSelector)
    ...
    override fun onCreateView(
        ...
        overlay = Overlay(requireContext())
        val layoutOverlay = ViewGroup.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.MATCH_PARENT
        );
        this.activity!!.addContentView(overlay,layoutOverlay)
